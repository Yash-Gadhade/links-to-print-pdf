...
https://raw.githubusercontent.com/adobe-webplatform/dropcap.js/master/dropcap.min.js
*/
...
(function () {
  var caps = document.querySelectorAll(".article-dropcap");
  window.Dropcap.layout(caps, 2);
})();
